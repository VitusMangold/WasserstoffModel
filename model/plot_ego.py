...
df_line_200kV = df_line.loc[(df_line["scn_name"] == "Status Quo") & (df_line["version"] == "v0.4.6")]
plot_df(df_line_200kV)
plt.show()
...
print(df_bus_200kV)
df_line_200kV = df_line_200kV[df_line_200kV['bus0'].isin(bus_ids_220kV) | df_line_200kV['bus1'].isin(bus_ids_220kV)]
plot_df(df_line_200kV)
plt.show()
